...
<template>
    <div class="p-10">
        <h1 class="font-bold text-2xl mb-10">Kanban Manager</h1>
        ...
        <div v-else>
            <div class="grid grid-cols-5 gap-10">
                ...
                <UiCardHeader role="button" @click="store.set(card)">
                    <UiCardTitle class="text-base leading-6">
                        {{ card.name }}
                    </UiCardTitle>
              
                <UiCardDescription >{{ convertCurrency(card.price) }}</UiCardDescription>
                  </UiCardHeader>
                <UiCardContent class="border-l border-gray-700 ml-3">
                    <div class="font-light text-xs opacity-70">Entreprise :</div>
